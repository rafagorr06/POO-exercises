...
class Alumno : public Persona{
	...
	public:
		Alumno(float promedio, int materias, string apellido, string nombre, string estcivil, int dni, int fechan): Persona(apellido, nombre, estcivil, dni, fechan){
			m_promedio = promedio;
...
class Curso{
	...
	vector<Alumno>v;
	public:
		Curso(string materia, Docente profe){
			m_materia = materia;
			m_docente = profe;
		}
		Docente VerDocente(){
